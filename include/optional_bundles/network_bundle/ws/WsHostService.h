...
#include <flow/optional_bundles/network_bundle/ws/WsConnectionService.h>
#include <flow/optional_bundles/network_bundle/ws/WsEvents.h>
#include <thread>
...
namespace flow {
    ...
    public:
        WsHostService(DependencyRegister &reg, flowProperties props);
