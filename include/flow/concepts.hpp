...
/**
 * These are tags used by the make_routine<tag> and make_subnet<tag> to generate implementations of
 * the tags to be spun up by the network
 */
struct consumer {};
struct spinner {};
struct producer {};
...
/**
 * These concepts are used to determine if a routine is an implementation of a routine generated by make_routine<tag>
 *
...
/// used by make_routine to know where to dispatch the tag detected
