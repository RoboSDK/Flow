...
namespace flow {
    ...
    using flowProperties = std::unordered_map<std::string, std::any, string_hash>;
#else
    using flowProperties = std::unordered_map<std::string, std::any>;
#endif
